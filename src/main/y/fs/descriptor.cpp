...
namespace upsylon
{
    namespace ios
    {
        ...
        void descriptor:: get( type handle, void *data, size_t size, size_t &done )
        {
        ...
        DONE_GET:
            ...
            if( ans != 0 )
            {
                throw os_exception( ans, "descriptor::get" );
            }

        }


        void descriptor:: put( type handle, const void *data, size_t size, size_t &done )
        {
            assert( !(data==NULL&&size>0) );
        ...
        DONE_PUT:
            ...
            if( ans != 0 )
            {
                throw os_exception( ans, "descriptor::put" );
            }
        }

    ...
    namespace Lang
    {
        namespace Lexical
        {
            ...
            public:
                ...
                inline explicit CXX_Comment(Translator &t, const string &id) : EndOfLineComment(t,id,init) {} //!< initialize
                inline explicit CXX_Comment(Translator &t, const char   *id) : EndOfLineComment(t,id,init) {} //!< initialize

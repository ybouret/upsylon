...
namespace upsylon {
    ...
    struct comms
    {
        ...
        static const char *delivery_id(const delivery) throw(); //!< get identifier for delivery
        static const char *topology_id(const topology) throw(); //!< get identifier for topology

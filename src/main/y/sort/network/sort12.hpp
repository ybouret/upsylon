//! \file
#ifndef Y_NW_sort12_INCLUDED
#define Y_NW_sort12_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 12 items
	template <> struct network_sort<12> {
		static const unsigned I[39]; //!< I swap indices
		static const unsigned J[39]; //!< J swap indices
		//! sort...

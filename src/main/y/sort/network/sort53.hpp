//! \file
#ifndef Y_NW_sort53_INCLUDED
#define Y_NW_sort53_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 53 items
	template <> struct network_sort<53> {
		static const unsigned I[535]; //!< I swap indices
		static const unsigned J[535]; //!< J swap indices
		//! sort...

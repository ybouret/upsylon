//! \file
#ifndef Y_NW_sort60_INCLUDED
#define Y_NW_sort60_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 60 items
	template <> struct network_sort<60> {
		static const unsigned I[624]; //!< I swap indices
		static const unsigned J[624]; //!< J swap indices
		//! sort...

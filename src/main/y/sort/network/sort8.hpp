//! \file
#ifndef Y_NW_sort8_INCLUDED
#define Y_NW_sort8_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 8 items
	template <> struct network_sort<8> {
		static const unsigned I[19]; //!< I swap indices
		static const unsigned J[19]; //!< J swap indices
		//! sort...

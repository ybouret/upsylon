//! \file
#ifndef Y_NW_sort61_INCLUDED
#define Y_NW_sort61_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 61 items
	template <> struct network_sort<61> {
		static const unsigned I[640]; //!< I swap indices
		static const unsigned J[640]; //!< J swap indices
		//! sort...

//! \file
#ifndef Y_NW_sort7_INCLUDED
#define Y_NW_sort7_INCLUDED
#include "../network.hpp"
namespace upsylon {
		//! network sort for 7 items
	template <> struct network_sort<7> {
		static const unsigned I[16]; //!< I swap indices
		static const unsigned J[16]; //!< J swap indices
		//! sort...

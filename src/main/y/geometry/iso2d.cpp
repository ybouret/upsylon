        ...
        namespace geometry
            {
                ...
                {
                    const unit_t L[3] = {lhs.i,lhs.j,lhs.q};
                    const unit_t R[3] = {rhs.i,rhs.j,rhs.q};
        ...
        namespace geometry
            {
                                                                      ...
                                                                      const Vertex     &fallback)
                {
                    ...
                    else
                    {
                        ...
                        if(!insert(sp)) throw exception("unexpected multiple Iso2d::vertex @(%d,%d,+%d)!",int(c.i), int(c.j), int(c.q));
                        return up;
                    }
                }
                                                                      ...
                                                                      const Coordinate &c1, const Vertex &p1, const double v1)
                {
                    ...
                    else
                    {
                        ...
                        if(!insert(sp)) throw exception("unexpected multiple Iso2d::vertex @(%d,%d,+%d)-(%d,%d,+%d)!",
                                                        int(tag.lower.i), int(tag.lower.j), int(tag.lower.q),
                                                        int(tag.upper.i), int(tag.upper.j), int(tag.upper.q)
                                                        );
                        return up;
                    }
                }

...
namespace upsylon
{
	namespace mkl
	{
        ...
        template <> const unsigned numeric<real_t>::mant_dig     = REAL_MANT_DIG;
        ...
        template <> const unsigned numeric<real_t>::dig          = REAL_DIG;
        ...
        template <> const unsigned numeric<real_t>::sqrt_dig     = dig/2+1;
        template <> const real_t numeric<real_t>::sqrt_ftol    = REAL(pow)( REAL(10.0), -real_t(sqrt_dig) );

//! \file
#ifndef Y_CRYPTO_BC_FACTORY_INCLUDED
#define Y_CRYPTO_BC_FACTORY_INCLUDED
...
namespace upsylon
{
    namespace crypto
    {
        ...
        private:
            ...
            static const at_exit::longevity life_time = 19; // TODO: chek
            Y_DISABLE_COPY_AND_ASSIGN(block_cipher_factory);
        };
    }
}

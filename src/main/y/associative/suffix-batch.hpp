...
namespace upsylon {
    ...
    public:
        ...
        //! setup
        inline explicit suffix_batch() :  base_type(), suffix_tree<T>()
        {
        }
        
        //! setup with capacity
        inline explicit suffix_batch(const size_t n, const as_capacity_t &_) :
        base_type(), suffix_tree<T>(n,_)
        {
        }
        
        //! hard copy
        inline suffix_batch( const suffix_batch &other ) :

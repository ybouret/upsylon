...
namespace upsylon
{
    ...
    public:
        ...
        const mpn      _probe;  //!< next prime probe 5+k*6>=highest prime
        const mpn  _0;          //!< 0
        const mpn  _1;          //!< 1
        const mpn  _2;          //!< 2
        const mpn  _3;          //!< 3
        ...
        void append_primes( const size_t count ); //!< append count primes to the primes sequence
        void load_primes( ios::istream &fp );     //!< load primes as generated by mprimes

...
namespace upsylon
{
    ...
    namespace graphic
    {
        template <> float convert<float,uint8_t>:: from(const uint8_t &u) throw()
        {
            return crux::convert::unit_float[u];
        }
        
        template <> rgb convert<rgb,uint8_t>:: from(const uint8_t &u) throw()
        {
            return rgb(u,u,u);
        }
        
        template <> rgba convert<rgba,uint8_t>:: from(const uint8_t &u) throw()
        {
            return rgba(u,u,u);
        }
        ...
        template <>
        YUV convert<YUV,uint8_t>:: from(const uint8_t &u) throw()
        {
            return YUV(crux::convert::unit_float[u],0,0);
        }
...
#define _F(X) (X##.0f/255.0f)
            ...
            const float convert:: unit_float[256] =
            {

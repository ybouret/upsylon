...
We want to minimize:
\begin{equation}
	F(\vec{A}) = \dfrac{1}{2} \vec{\Gamma}^t \bm{W} \vec{\Gamma}
\end{equation}

\begin{equation}
\begin{array}{rcl}
	F(\vec{A}_n + \delta\vec{A}_n) & \simeq & \dfrac{1}{2} (\vec{\Gamma}_n + \bm{\Phi} \delta\vec{A}_n)^t \bm{W} (\vec{\Gamma}_n + \bm{\Phi} \delta\vec{A}_n)\\
	\\
	& \simeq & \dfrac{1}{2}  \vec{\Gamma}_n^t \bm{W} \vec{\Gamma}_n + \vec{\Gamma}_n^t \bm{W} \bm{\Phi} \delta\vec{A}_n \\
	\\
	& \simeq & \dfrac{1}{2}  \vec{\Gamma}_n^t \bm{W} \vec{\Gamma}_n + \vec{\Gamma}_n^t \bm{W} \bm{\Phi} \bm{\nu}^t \vec{\xi}_n\\
\end{array}
 \end{equation}

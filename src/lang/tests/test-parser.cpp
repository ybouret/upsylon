        ...
        explicit myParser() : Syntax::Parser("JSON")
        {
            ...
            ALT &jArray = alt("array");
            {
                ...
                }
                {
                    ...
                    HeavyArray << zeroOrMore( acting("extra_value") << COMA << value );
                    HeavyArray << RBRACK;
                    jArray << HeavyArray;
                }
            }
            ...
            ALT &jObject = alt("object");
            {
                ...
                }
                {
                    ...
                    HeavyObject << LBRACE;
                    {
                        ...
                        HeavyObject << jPair;
                        HeavyObject << zeroOrMore( acting("extra_pair") << COMA << jPair );
                    }
                    HeavyObject << RBRACE;
                    jObject << HeavyObject;
                }
...
Y_UTEST(parser)
{
    ...
    if(argc>1&&0==strcmp(argv[1],"run"))
    {
        ...
        auto_ptr<Syntax::Node> ast = json.parse(source,true);
        json.raw->GraphViz("traw.dot");

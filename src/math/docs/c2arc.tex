...
\left\lbrace
\begin{array}{rcl}
%4\vec{Q}_i + \vec{3}\vec{W}_i & = & 12\left(\vec{V}_{i'}-\vec{V}_i\right) - 6 \left( \vec{A}_i+\vec{A}_{i'} \right)\\
%5\vec{Q}_i + \vec{3}\vec{W}_i & = & 60\left(\vec{P}_{i'}-\vec{P}_i - \vec{V}_i\right) - 10\left(2\vec{A}_i  + \vec{A}_{i'}  \right)\\
\end{array}
\right.
\end{equation}
